...
if __name__ == '__main__':
    ans = {'outlook':{'sunny':{'humidity':{'high':'no','normal':'yes'}},'overcast':'yes','rainy':{'wind':{'weak':'yes','strong':'no'}}}}
    # ans1 {'outlook':{'sunny':{'humidity':{'high':'no','normal':'yes'}},'overcast':'yes','rainy':{'wind':{'weak':'yes','strong':'no'}}}}
    ID3_Tree(ans)
